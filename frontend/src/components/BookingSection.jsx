...
const BookingSection = () => {
  ...
  const tourPackages = [
    {
      ...
      itinerary: [
        ...
        },
        {
          ...
          activities: ["Temple tour", "Traditional market", "Cooking class"],
        },
        {
          day: 3,
          title: "Adventure Day",
          activities: ["Volcano hiking", "Rice terrace visit", "Hot springs"],
        },
      ],
    },
    {
      ...
      itinerary: [
        ...
        },
        {
          ...
          activities: ["Desert safari", "Camel riding", "BBQ dinner"],
        },
        {
          day: 3,
      ...
      itinerary: [
        {
          ...
          activities: ["Airport transfer", "City tour", "Lake cruise"],
        },
        {
          day: 2,
          title: "Jungfraujoch Trip",
          activities: ["Train journey", "Top of Europe", "Ice palace"],
        },
        {
          day: 3,
          title: "Interlaken Adventure",
          activities: ["Paragliding", "Lake activities", "Mountain hiking"],
        },
      ],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        className='absolute bottom-20 right-20 w-32 h-32 bg-purple-200/20 rounded-full blur-xl animate-float'
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16 animate-fade-in'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            Choose from our curated travel packages and create unforgettable
            memories
          </p>
        </div>
            ...
            <div className='bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 mb-8'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    <p className='font-semibold'>
                      {tourPackages.find(p => p.id === selectedPackage)?.title}
                    </p>
                    <p className='text-sm text-gray-600'>
                      {
                        tourPackages.find(p => p.id === selectedPackage)
                          ?.location
                      }
                    </p>
                  </div>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    <p className='font-semibold'>
                      ${tourPackages.find(p => p.id === selectedPackage)?.price}
                    </p>
                    <p className='text-sm text-gray-600'>per person</p>
                  </div>
                </div>
