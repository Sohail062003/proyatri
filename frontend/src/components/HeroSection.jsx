  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0'>
        ...
        <div
          className='absolute top-20 left-10 w-32 h-32 bg-blue-400/20 rounded-full blur-xl animate-bounce'
          style={{ animationDelay: "2s", animationDuration: "4s" }}
        />
        <div
          className='absolute bottom-32 right-16 w-24 h-24 bg-purple-400/20 rounded-full blur-xl animate-bounce'
          style={{ animationDelay: "1s", animationDuration: "5s" }}
        />
        <div
          className='absolute top-1/2 right-1/4 w-16 h-16 bg-cyan-400/20 rounded-full blur-xl animate-bounce'
          style={{ animationDelay: "3s", animationDuration: "6s" }}
        />
      </div>

      <div
        className={`relative z-10 text-center text-white px-4 max-w-6xl mx-auto transition-all duration-1000 ${
      ...
      >
        <div className='mb-8'>
          ...
          <p
            className={`text-lg md:text-xl mb-8 max-w-4xl mx-auto leading-relaxed transition-all duration-1000 delay-500 ${
              isLoaded
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            We Believe Everyone Should Travel Because Travelling's For Everyone.
            We Make Vacations Magical Making Life The Daring Adventure You
            Deserve.
          </p>

          <button
            className={`bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-10 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-110 shadow-2xl hover:shadow-blue-500/25 transition-all duration-1000 delay-700 ${
              isLoaded
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
        ...
        <form
          ...
          className={`bg-white/95 backdrop-blur-lg p-8 rounded-2xl shadow-2xl max-w-5xl mx-auto mt-12 border border-white/20 transition-all duration-1000 delay-1000 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
