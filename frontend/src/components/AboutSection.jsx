  ...
  return (
    ...
    >
      <div className='container mx-auto px-4'>
        ...
        >
          <p className='text-blue-500 text-lg mb-4 font-semibold tracking-wide'>
            Know About Us
          </p>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          ...
          >
            ...
            <div className='space-y-6 text-gray-700 text-lg leading-relaxed'>
              <p>
                At Proyatri, we believe that travel is not just about visiting
                new places; it's about creating unforgettable memories and
                life-changing experiences.
              </p>
              <p>
                From exotic tropical getaways to cultural city breaks, from
                adventurous mountain expeditions to relaxing beach retreats, we
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 my-8'>
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`flex items-center space-x-3 p-4 bg-white rounded-xl shadow-lg transition-all duration-500 hover:shadow-xl hover:scale-105 ${
                      isVisible
          ...
          >
            ...
            <div className='space-y-6 mt-8'>
              ...
              />
              <img
                src='https://images.unsplash.com/photo-1520637836862-4d197d17c52a?auto=format&fit=crop&w=500&q=80'
