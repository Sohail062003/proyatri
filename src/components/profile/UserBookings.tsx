...
import { Calendar, MapPin, Users, IndianRupee, Clock, Filter, Search } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button variant="ghost" className="text-white hover:bg-green-700 font-semibold">
                My Booking
              </Button>
            </div>
          </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50">
                    ...
                    <TableHead className="font-semibold">Participant Count</TableHead>
                    <TableHead className="font-semibold">Price</TableHead>
                    <TableHead className="font-semibold">Partial Payment</TableHead>
                    ...
                    <TableRow key={booking.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-1 text-gray-600">
                          ...
                          <span>{new Date(booking.executionDate).toLocaleDateString()}</span>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center space-x-1 text-gray-600">
