...
import { ChevronLeft, ChevronRight, X, MapPin, Heart, Share2 } from 'lucide-react';
...
const GallerySection = () => {
  ...
  return (
    <section id="gallery" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-40 left-20 w-32 h-32 bg-purple-200/20 rounded-full blur-xl animate-float" style={{ animationDelay: '3s' }} />

      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
            Travel <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Gallery</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover breathtaking destinations through our collection of stunning travel photography
          </p>
        </div>
