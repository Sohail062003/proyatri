    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`h-4 w-4 transition-transform ${activeDropdown === 'northIndia' ? 'rotate-180' : ''}`} />
                </button>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`h-4 w-4 transition-transform ${activeDropdown === 'southIndia' ? 'rotate-180' : ''}`} />
                </button>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`h-4 w-4 transition-transform ${activeDropdown === 'weekends' ? 'rotate-180' : ''}`} />
                </button>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`h-4 w-4 transition-transform ${activeDropdown === 'international' ? 'rotate-180' : ''}`} />
                </button>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Explore amazing destinations and plan your next adventure</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Countries Explored</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-4 border rounded-lg hover:bg-gray-50">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Kashmir Paradise</h3>
                ...
                <div className="flex items-center space-x-4 p-4 border rounded-lg hover:bg-gray-50">
                  ...
                  />
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Kerala Backwaters</h3>
